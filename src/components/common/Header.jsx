      ...
      <header className="bg-red-40">
        <nav className="container relative z-50 flex w-full items-center justify-between py-[14px] font-poppins sm:py-[16px] md:py-[18px] lg:py-[20px] xl:py-[24px] xxl:py-[26px]">
          ...
          >
            ...
            <li className="hover:text-blue-500">Our cabins</li>
            <li>Get inspired</li>
            <li>Gift a stay</li>
            <li>About us</li>
            {isMenuOpen ? (
              ...
              <li className="hidden items-center justify-center rounded-full border border-[#3F3F3F] bg-[#F2FAF9] lg:flex lg:h-[38px] lg:w-[38px] xl:h-[42px] xl:w-[42px] xxl:h-[48px] xxl:w-[48px]">
        ...
        {
          isMenuOpen && <div className="fixed top-0 right-0 bottom-0 left-0 bg-[rgba(207,207,207,0.5)] z-40" onClick={toggleMenu
          }></div>
        }
      </header>
    </>
