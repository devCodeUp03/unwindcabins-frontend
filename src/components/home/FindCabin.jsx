...
const FindCabin = () => {
  return (
    <div className="bg-[#F2FAF9] py-[32px] px-[40px] sm:py-[36px] sm:px-[48px] md:py-[44px] md:px-[56px] lg:py-[52px] lg:px-[68px] xl:py-[64px] xl:px-[82px] xxl:py-[78px] xxl:px-[100px]"> 
      <div className="container h-[260px] bg-[url('/assets/bg-image.png')] bg-cover bg-no-repeat text-white sm:h-[320px] md:h-[384px] md:p-12 lg:h-[460px] lg:p-14 xl:h-[552px] flex items-center">
